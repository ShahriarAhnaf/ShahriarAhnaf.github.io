...
const resume = `${github}/resume/blob/embedded/Ahnaf_Shahriar_Resume.pdf`;
...
export default function Home() {
  return <>
    ...
    <header className="site-header">
      ...
      <nav aria-label="Main navigation"><a href="#work">Work</a><a href="#experience">Experience</a><a href="#about">About</a><a href="/blog/">Writing</a></nav>
